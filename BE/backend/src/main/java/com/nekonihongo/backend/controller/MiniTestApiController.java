...
// public ResponseEntity<?> checkTestStatus(@RequestParam("lesson_id") Integer
// lessonId) {
// try {
// System.out.println("🔍 [MiniTestApiController] Checking test status for
// lesson: " + lessonId);
...
// @PostMapping("/submit")
// @PreAuthorize("hasRole('USER') or hasRole('ADMIN')")
// public ResponseEntity<?> submitTest(@RequestBody SubmitTestRequestDTO
// request) {
// try {
